...
BLOCK_IDENTIFIER = "rc_low_pass"
BLOCK_VERSION = "m8.8"
BLOCK_CATEGORY = "filters"
BLOCK_MATURITY = "mvp"
BLOCK_ARCHETYPE_ID = "rc_low_pass_vertical_slice"


@dataclass(frozen=True, slots=True)
class RcLowPassTopologyBlock:
    ...
    generated_subgraph: tuple[str, ...] = ("vin", "R", "vout", "C", "gnd")

    @property
    def summary(self) -> str:
        return "Isolated RC low-pass topology block MVP"
...
RC_LOW_PASS_BLOCK = RcLowPassTopologyBlock()


def build_rc_low_pass(
    *,
    resistance_ohms: float,
    capacitance_farads: float,
    vin: str,
    ...
    """Build the isolated rc_low_pass topology block as a deterministic CircuitGraph."""
